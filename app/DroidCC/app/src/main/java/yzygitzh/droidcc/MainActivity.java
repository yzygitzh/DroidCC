...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //String testViewInfoStr = "screenX=12;screenY=170;thisWidth=146;thisHeight=23;rootWidth=320;rootHeight=480;thisResId=com.deve;xpert.weather:id/text_weather_home;rootResId=";
        String testViewInfoStr = "thisRect=390 449 742 491;rootRect=0 0 768 1280;thisResId=com.devexpert.weather:id/text_mylocation_home;rootResId=";
